...
```mermaid
graph TD
    Main["main.md"] --> Core["Core Rules<br>(Always Loaded)"]
...
|--------|------|-------------|
| **Core** | `core/code-quality.md` | Rust 2024, no unsafe, production-ready code |
| **Core** | `core/dependencies.md` | Centralized dependency management and workspace patterns |
| **Core** | `core/type-system.md` | Type system mastery, newtype patterns, phantom types |
| **Core** | `core/performance.md` | Performance optimization, SIMD, memory management |
| **Core** | `core/security.md` | Security patterns, Argon2 hashing, encryption |
| **Core** | `core/api-design.md` | Ergonomic API design, builder patterns, trait design |
| **Core** | `core/design-patterns.md` | Essential design patterns, actor model, strategy |
| **Simple** | `simple/single-crate.md` | Single crate project structure |
| **Complex** | `complex/workspace.md` | Multi-crate workspace management |
| **Web** | `features/axum.md` | Axum 0.8 patterns, OpenAPI with utoipa |
| **Database** | `features/database.md` | SQLx patterns, repository design, testing |
| **CLI** | `features/cli.md` | Clap 4.0+ patterns, subcommands, enum_dispatch |
| **Protobuf & gRPC** | `features/protobuf-grpc.md` | Prost/Tonic 0.13+, Inner types, MessageSanitizer, reflection |
| **Concurrency** | `features/concurrency.md` | Tokio, DashMap, async patterns |
| **Configuration** | `features/configuration.md` | Multi-format config, hot-reloading, validation patterns |
| **Observability** | `features/observability.md` | Metrics collection, distributed tracing, health checks |
| **Tools & Config** | `features/tools-and-config.md` | Tracing, YAML config, MiniJinja templates |
| **Utilities** | `features/utilities.md` | JWT auth, CLI tools, builders, enhanced derives |
| **HTTP Client** | `features/http-client.md` | reqwest patterns, error handling, retry logic |
| **Testing** | `quality/testing.md` | Unit testing standards |
| **Errors** | `quality/error-handling.md` | thiserror/anyhow patterns |
